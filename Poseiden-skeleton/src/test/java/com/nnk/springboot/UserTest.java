...
public class UserTest {
    ...
    public void getUpdateUserTest() throws Exception {
        ...
        // THEN
        this.mockMvc
                .perform(get("/user/update/1").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andDo(print())
    ...
    public void getDeleteUserTest() throws Exception {
        ...
        // THEN
        this.mockMvc
                .perform(get("/user/delete/1").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andDo(print())
